...
\begin{figure}[tbh]
  \begin{centering}
    \subfigure[Beschaltung]{\includegraphics[width = 0.4\textwidth]{Bilder/US-Sensor}}
    \subfigure[Messsignale]{\includegraphics[width = 0.4\textwidth]{Bilder/Ultraschallmessung}}
  \par\end{centering}
